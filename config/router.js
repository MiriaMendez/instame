...
const upload = require('../config/couldinary.config')

module.exports = router;

router.post('/register', upload.single('img'), usersController.create)
...
router.post('/post/create', authMiddleware.isAuthenticated, upload.single('img'), postController.create)
